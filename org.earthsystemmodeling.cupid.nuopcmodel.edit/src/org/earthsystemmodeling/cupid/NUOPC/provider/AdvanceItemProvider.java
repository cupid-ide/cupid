...
/**
 * This is the item provider adapter for a {@link org.earthsystemmodeling.cupid.NUOPC.Advance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AdvanceItemProvider extends SpecializationItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((Advance)object).getPhaseLabel();
		/*
		...
		*/
		return label == null || label.length() == 0 ?
				"Advance (" + ((Advance)object).getComponent().getName() + ")" :
				"Advance " + label + "(" + ((Advance)object).getComponent().getName() + ")";
	}
