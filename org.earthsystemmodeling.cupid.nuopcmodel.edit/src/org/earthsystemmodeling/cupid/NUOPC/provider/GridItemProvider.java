...
/**
 * This is the item provider adapter for a {@link org.earthsystemmodeling.cupid.NUOPC.Grid} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Grid_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Grid_name_feature", "_UI_Grid_type"),
				 NUOPCPackage.Literals.GRID__NAME,
				 true,
				 false,
				 false,
	...
	protected void addMinIndexPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Grid_minIndex_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Grid_minIndex_feature", "_UI_Grid_type"),
				 NUOPCPackage.Literals.GRID__MIN_INDEX,
				 true,
				 false,
				 false,
	...
	protected void addMaxIndexPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Grid_maxIndex_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Grid_maxIndex_feature", "_UI_Grid_type"),
				 NUOPCPackage.Literals.GRID__MAX_INDEX,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
