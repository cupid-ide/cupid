...
public class CupidToEcore {
	...
	public static void main(String[] args) throws IOException {
		...
		URI uri = URI.createURI("../org.earthsystemmodeling.cupid.gen/model/nuopc.cupid");
		// Resource xtextResource = resourceSet.createResource(uri);
		Resource xtextResource = resourceSet.getResource(uri, true);
		
		EcoreUtil.resolveAll(xtextResource);
		
		Resource xmiResource = resourceSet.createResource(URI.createURI("../org.earthsystemmodeling.cupid.gen/model/nuopc.xmi"));
		...
		URI inputURI = URI.createURI("../org.earthsystemmodeling.cupid.gen/model/nuopc.oclinecore");
		URI ecoreURI = URI.createURI("../org.earthsystemmodeling.cupid.gen/model/nuopc.ecore");
