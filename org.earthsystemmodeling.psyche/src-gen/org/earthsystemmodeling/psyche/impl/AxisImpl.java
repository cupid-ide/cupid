 ...
 * <ul>
 *   <li>{@link org.earthsystemmodeling.psyche.impl.AxisImpl#isAncestor <em>Ancestor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AxisImpl extends MinimalEObjectImpl.Container implements Axis
{
  ...
  {
    return PsychePackage.Literals.AXIS;
  }
  ...
  public void setAncestor(boolean newAncestor)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PsychePackage.AXIS__ANCESTOR, oldAncestor, ancestor));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PsychePackage.AXIS__ANCESTOR:
        return isAncestor();
    }
