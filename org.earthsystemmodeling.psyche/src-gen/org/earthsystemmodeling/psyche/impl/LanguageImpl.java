 ...
 * <ul>
 *   <li>{@link org.earthsystemmodeling.psyche.impl.LanguageImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.earthsystemmodeling.psyche.impl.LanguageImpl#getUri <em>Uri</em>}</li>
 *   <li>{@link org.earthsystemmodeling.psyche.impl.LanguageImpl#getConceptDef <em>Concept Def</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LanguageImpl extends MinimalEObjectImpl.Container implements Language
{
  ...
  {
    return PsychePackage.Literals.LANGUAGE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PsychePackage.LANGUAGE__NAME, oldName, name));
  }
  ...
  public void setUri(String newUri)
  {
    ...
    uri = newUri;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PsychePackage.LANGUAGE__URI, oldUri, uri));
  }
  ...
  public EList<ConceptDef> getConceptDef()
  {
    if (conceptDef == null)
    {
      conceptDef = new EObjectContainmentEList<ConceptDef>(ConceptDef.class, this, PsychePackage.LANGUAGE__CONCEPT_DEF);
    }
    return conceptDef;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PsychePackage.LANGUAGE__CONCEPT_DEF:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PsychePackage.LANGUAGE__NAME:
        return getName();
      case PsychePackage.LANGUAGE__URI:
        return getUri();
      case PsychePackage.LANGUAGE__CONCEPT_DEF:
