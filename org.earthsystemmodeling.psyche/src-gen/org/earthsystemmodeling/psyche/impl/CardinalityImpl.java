 ...
 * <ul>
 *   <li>{@link org.earthsystemmodeling.psyche.impl.CardinalityImpl#isZeroOrOne <em>Zero Or One</em>}</li>
 *   <li>{@link org.earthsystemmodeling.psyche.impl.CardinalityImpl#isZeroOrMore <em>Zero Or More</em>}</li>
 *   <li>{@link org.earthsystemmodeling.psyche.impl.CardinalityImpl#isOneOrMore <em>One Or More</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CardinalityImpl extends MinimalEObjectImpl.Container implements Cardinality
{
  ...
  {
    return PsychePackage.Literals.CARDINALITY;
  }
  ...
  public void setZeroOrOne(boolean newZeroOrOne)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PsychePackage.CARDINALITY__ZERO_OR_ONE, oldZeroOrOne, zeroOrOne));
  }
  ...
  public void setZeroOrMore(boolean newZeroOrMore)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PsychePackage.CARDINALITY__ZERO_OR_MORE, oldZeroOrMore, zeroOrMore));
  }
  ...
  public void setOneOrMore(boolean newOneOrMore)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PsychePackage.CARDINALITY__ONE_OR_MORE, oldOneOrMore, oneOrMore));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PsychePackage.CARDINALITY__ZERO_OR_ONE:
        return isZeroOrOne();
      case PsychePackage.CARDINALITY__ZERO_OR_MORE:
        return isZeroOrMore();
      case PsychePackage.CARDINALITY__ONE_OR_MORE:
        return isOneOrMore();
    }
