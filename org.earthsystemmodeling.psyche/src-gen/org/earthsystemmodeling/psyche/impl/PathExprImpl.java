 ...
 * <ul>
 *   <li>{@link org.earthsystemmodeling.psyche.impl.PathExprImpl#getHead <em>Head</em>}</li>
 *   <li>{@link org.earthsystemmodeling.psyche.impl.PathExprImpl#getTail <em>Tail</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PathExprImpl extends MinimalEObjectImpl.Container implements PathExpr
{
  ...
  {
    return PsychePackage.Literals.PATH_EXPR;
  }
  ...
  public NotificationChain basicSetHead(PathExpr newHead, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PsychePackage.PATH_EXPR__HEAD, oldHead, newHead);
  ...
  public void setHead(PathExpr newHead)
  {
    if (newHead != head)
    {
      ...
      if (head != null)
        msgs = ((InternalEObject)head).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PsychePackage.PATH_EXPR__HEAD, null, msgs);
      if (newHead != null)
        msgs = ((InternalEObject)newHead).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PsychePackage.PATH_EXPR__HEAD, null, msgs);
      msgs = basicSetHead(newHead, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PsychePackage.PATH_EXPR__HEAD, newHead, newHead));
  }
  ...
  public SubconceptOrAttribute getTail()
  {
    if (tail != null && tail.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PsychePackage.PATH_EXPR__TAIL, oldTail, tail));
      }
    }
    return tail;
  }
  ...
  public void setTail(SubconceptOrAttribute newTail)
  {
    ...
    tail = newTail;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PsychePackage.PATH_EXPR__TAIL, oldTail, tail));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PsychePackage.PATH_EXPR__HEAD:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PsychePackage.PATH_EXPR__HEAD:
        return getHead();
      case PsychePackage.PATH_EXPR__TAIL:
