...
public class PsycheSyntacticSequencer extends AbstractSyntacticSequencer {

	protected PsycheGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (PsycheGrammarAccess) access;
