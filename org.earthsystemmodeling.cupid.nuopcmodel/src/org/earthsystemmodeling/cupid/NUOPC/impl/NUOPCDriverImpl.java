 ...
 * </p>
 * <ul>
 *   <li>{@link org.earthsystemmodeling.cupid.NUOPC.impl.NUOPCDriverImpl#getChildren <em>Children</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NUOPCDriverImpl extends NUOPCComponentImpl implements NUOPCDriver {
	/**
	...
	public EList<NUOPCComponent> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<NUOPCComponent>(NUOPCComponent.class, this, NUOPCPackage.NUOPC_DRIVER__CHILDREN);
		}
		return children;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case NUOPCPackage.NUOPC_DRIVER__CHILDREN:
