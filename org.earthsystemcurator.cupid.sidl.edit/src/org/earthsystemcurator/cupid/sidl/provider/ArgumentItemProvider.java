...
/**
 * This is the item provider adapter for a {@link org.earthsystemcurator.cupid.sidl.Argument} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArgumentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SIDLPackage.Literals.ARGUMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addModePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Argument_mode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Argument_mode_feature", "_UI_Argument_type"),
				 SIDLPackage.Literals.ARGUMENT__MODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SIDLPackage.Literals.ARGUMENT__TYPE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SIDLPackage.Literals.ARGUMENT__TYPE,
