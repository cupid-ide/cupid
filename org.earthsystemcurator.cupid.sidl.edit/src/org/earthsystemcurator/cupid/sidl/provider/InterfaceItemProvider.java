...
/**
 * This is the item provider adapter for a {@link org.earthsystemcurator.cupid.sidl.Interface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SIDLPackage.Literals.INTERFACE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addParentInterfacePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interface_parentInterface_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interface_parentInterface_feature", "_UI_Interface_type"),
				 SIDLPackage.Literals.INTERFACE__PARENT_INTERFACE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SIDLPackage.Literals.INTERFACE__METHOD);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SIDLPackage.Literals.INTERFACE__METHOD,
