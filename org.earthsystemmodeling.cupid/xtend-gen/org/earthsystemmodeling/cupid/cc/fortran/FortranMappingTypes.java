    ...
    final Procedure1<MappingType> _function_1 = (MappingType it) -> {
      final Procedure1<MappingTypeBinding> _function_2 = (MappingTypeBinding bind) -> {
        ...
        if (_notEquals) {
          boolean _or = false;
          boolean _or_1 = false;
          Set<ASTRenameNode> _findAll = useStmtNode.<ASTRenameNode>findAll(ASTRenameNode.class);
          ...
          if (_exists) {
            ...
            Set<ASTOnlyNode> _findAll_1 = useStmtNode.<ASTOnlyNode>findAll(ASTOnlyNode.class);
          ...
          if (_or_1) {
            ...
            _or = (IterableExtensions.isNullOrEmpty(useStmtNode.<ASTRenameNode>findAll(ASTRenameNode.class)) && 
              IterableExtensions.isNullOrEmpty(useStmtNode.<ASTOnlyNode>findAll(ASTOnlyNode.class)));
          }
      ...
      final Procedure1<MappingTypeBinding> _function_3 = (MappingTypeBinding bind) -> {
        ...
        final ASTUseStmtNode usn = FortranMappingTypes.ensureImport(moduleNode, uses, entity, localName, true);
        bind.<ASTUseStmtNode>setMatch(usn);
      };
