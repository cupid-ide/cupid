    ...
    try {
      String _xblockexpression = null;
      {
        ...
        _builder.append(".o ");
        {
          ...
          Iterable<Component> _filter = IterableExtensions.<Component>filter(app.getAllChildren(), _function);
        ...
        _builder.append(".o: ");
        {
          Iterable<Driver> _filter_1 = Iterables.<Driver>filter(app.getChildren(), Driver.class);
        ...
        _builder.newLineIfNotEmpty();
        {
          Iterable<Driver> _filter_2 = Iterables.<Driver>filter(app.getChildren(), Driver.class);
          for(final Driver d_1 : _filter_2) {
            {
              int _size = d_1.getChildren().size();
              ...
              if (_greaterThan) {
                ...
                _builder.append(".o:  ");
                {
                  ...
                  Iterable<Component> _filter_3 = IterableExtensions.<Component>filter(d_1.getChildren(), _function_1);
