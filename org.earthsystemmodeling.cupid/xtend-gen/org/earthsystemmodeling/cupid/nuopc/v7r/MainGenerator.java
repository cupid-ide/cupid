  ...
  public static String generate(final Application app) {
    try {
      String _xblockexpression = null;
      {
        ...
        int _size = IterableExtensions.size(Iterables.<Driver>filter(app.getChildren(), Driver.class));
        ...
        final Driver driver = ((Driver[])Conversions.unwrapArray(Iterables.<Driver>filter(app.getChildren(), Driver.class), Driver.class))[0];
