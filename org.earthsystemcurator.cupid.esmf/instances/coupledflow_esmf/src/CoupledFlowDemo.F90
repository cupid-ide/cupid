...
! $Id: CoupledFlowDemo.F90,v 1.19 2011/06/30 05:58:24 theurich Exp $
!
!------------------------------------------------------------------------------
!BOE
!
...
!	VT_MARKER_DEF('mymarker', VT_MARKER_TYPE_HINT, vtmarker)
!	VT_MARKER(vtmarker, 'register') 
...
!	VT_MARKER(vtmarker, 'init') 
    ...
    if (petCount .eq. 1) then
      ...
      if ((petCount .lt. 4) .or. (petCount .gt. 96) &
