...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Action Grid Comp Set Services</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.earthsystemcurator.cupid.esmf.impl.ESMFActionGridCompSetServicesImpl#getGridcomp <em>Gridcomp</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.esmf.impl.ESMFActionGridCompSetServicesImpl#getUserRoutine <em>User Routine</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.esmf.impl.ESMFActionGridCompSetServicesImpl#getUserRC <em>User RC</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ESMFActionGridCompSetServicesImpl extends ESMFActionAPIImpl implements ESMFActionGridCompSetServices {
	/**
	 ...
	 * @generated
	 */
	protected ESMFActionGridCompSetServicesImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ESMFPackage.Literals.ESMF_ACTION_GRID_COMP_SET_SERVICES;
	}
		...
		if (gridcomp != null && gridcomp.eIsProxy()) {
			...
			if (gridcomp != oldGridcomp) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ESMFPackage.ESMF_ACTION_GRID_COMP_SET_SERVICES__GRIDCOMP, oldGridcomp, gridcomp));
			}
		}
		return gridcomp;
	}
	...
	public void setGridcomp(ESMFComponent newGridcomp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ESMFPackage.ESMF_ACTION_GRID_COMP_SET_SERVICES__GRIDCOMP, oldGridcomp, gridcomp));
	}
	...
	public void setUserRoutine(String newUserRoutine) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ESMFPackage.ESMF_ACTION_GRID_COMP_SET_SERVICES__USER_ROUTINE, oldUserRoutine, userRoutine));
	}
	...
	public void setUserRC(String newUserRC) {
		...
		userRC = newUserRC;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ESMFPackage.ESMF_ACTION_GRID_COMP_SET_SERVICES__USER_RC, oldUserRC, userRC));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ESMFPackage.ESMF_ACTION_GRID_COMP_SET_SERVICES__GRIDCOMP:
...
} //ESMFActionGridCompSetServicesImpl
