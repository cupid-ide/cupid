...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Call Grid Comp Create</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.earthsystemcurator.cupid.esmf.impl.ESMFCallGridCompCreateImpl#getGridcomp <em>Gridcomp</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ESMFCallGridCompCreateImpl extends ESMFCallImpl implements ESMFCallGridCompCreate {
	/**
	 ...
	 * @generated
	 */
	protected ESMFCallGridCompCreateImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ESMFPackage.Literals.ESMF_CALL_GRID_COMP_CREATE;
	}
		...
		if (gridcomp != null && gridcomp.eIsProxy()) {
			...
			if (gridcomp != oldGridcomp) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ESMFPackage.ESMF_CALL_GRID_COMP_CREATE__GRIDCOMP, oldGridcomp, gridcomp));
			}
		}
		return gridcomp;
	}
	...
	public void setGridcomp(ESMFGriddedComponent newGridcomp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ESMFPackage.ESMF_CALL_GRID_COMP_CREATE__GRIDCOMP, oldGridcomp, gridcomp));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ESMFPackage.ESMF_CALL_GRID_COMP_CREATE__GRIDCOMP:
