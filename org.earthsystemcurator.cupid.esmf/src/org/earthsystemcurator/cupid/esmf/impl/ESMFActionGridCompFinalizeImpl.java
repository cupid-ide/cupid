...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Action Grid Comp Finalize</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.earthsystemcurator.cupid.esmf.impl.ESMFActionGridCompFinalizeImpl#getGridcomp <em>Gridcomp</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.esmf.impl.ESMFActionGridCompFinalizeImpl#getImportState <em>Import State</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.esmf.impl.ESMFActionGridCompFinalizeImpl#getExportState <em>Export State</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.esmf.impl.ESMFActionGridCompFinalizeImpl#getClock <em>Clock</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.esmf.impl.ESMFActionGridCompFinalizeImpl#getPhase <em>Phase</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ESMFActionGridCompFinalizeImpl extends ESMFActionAPIImpl implements ESMFActionGridCompFinalize {
	/**
	 ...
	 * @generated
	 */
	protected ESMFActionGridCompFinalizeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ESMFPackage.Literals.ESMF_ACTION_GRID_COMP_FINALIZE;
	}
		...
		if (gridcomp != null && gridcomp.eIsProxy()) {
			...
			if (gridcomp != oldGridcomp) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ESMFPackage.ESMF_ACTION_GRID_COMP_FINALIZE__GRIDCOMP, oldGridcomp, gridcomp));
			}
		}
		return gridcomp;
	}
	...
	public void setGridcomp(ESMFGriddedComponent newGridcomp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ESMFPackage.ESMF_ACTION_GRID_COMP_FINALIZE__GRIDCOMP, oldGridcomp, gridcomp));
	}
	...
	public ESMFState getImportState() {
		if (importState != null && importState.eIsProxy()) {
			...
			if (importState != oldImportState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ESMFPackage.ESMF_ACTION_GRID_COMP_FINALIZE__IMPORT_STATE, oldImportState, importState));
			}
		}
		return importState;
	}
	...
	public void setImportState(ESMFState newImportState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ESMFPackage.ESMF_ACTION_GRID_COMP_FINALIZE__IMPORT_STATE, oldImportState, importState));
	}
	...
	public ESMFState getExportState() {
		if (exportState != null && exportState.eIsProxy()) {
			...
			if (exportState != oldExportState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ESMFPackage.ESMF_ACTION_GRID_COMP_FINALIZE__EXPORT_STATE, oldExportState, exportState));
			}
		}
		return exportState;
	}
	...
	public void setExportState(ESMFState newExportState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ESMFPackage.ESMF_ACTION_GRID_COMP_FINALIZE__EXPORT_STATE, oldExportState, exportState));
	}
	...
	public ESMFClock getClock() {
		if (clock != null && clock.eIsProxy()) {
			...
			if (clock != oldClock) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ESMFPackage.ESMF_ACTION_GRID_COMP_FINALIZE__CLOCK, oldClock, clock));
			}
		}
		return clock;
	}
	...
	public void setClock(ESMFClock newClock) {
		...
		clock = newClock;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ESMFPackage.ESMF_ACTION_GRID_COMP_FINALIZE__CLOCK, oldClock, clock));
	}
	...
	public void setPhase(String newPhase) {
		...
		phase = newPhase;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ESMFPackage.ESMF_ACTION_GRID_COMP_FINALIZE__PHASE, oldPhase, phase));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ESMFPackage.ESMF_ACTION_GRID_COMP_FINALIZE__GRIDCOMP:
				if (resolve) return getGridcomp();
				return basicGetGridcomp();
			case ESMFPackage.ESMF_ACTION_GRID_COMP_FINALIZE__IMPORT_STATE:
				if (resolve) return getImportState();
				return basicGetImportState();
			case ESMFPackage.ESMF_ACTION_GRID_COMP_FINALIZE__EXPORT_STATE:
				if (resolve) return getExportState();
				return basicGetExportState();
			case ESMFPackage.ESMF_ACTION_GRID_COMP_FINALIZE__CLOCK:
...
} //ESMFActionGridCompFinalizeImpl
