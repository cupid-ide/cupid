...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Action Cpl Comp Finalize</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.earthsystemcurator.cupid.esmf.impl.ESMFActionCplCompFinalizeImpl#getCplcomp <em>Cplcomp</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.esmf.impl.ESMFActionCplCompFinalizeImpl#getImportState <em>Import State</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.esmf.impl.ESMFActionCplCompFinalizeImpl#getExportState <em>Export State</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.esmf.impl.ESMFActionCplCompFinalizeImpl#getClock <em>Clock</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.esmf.impl.ESMFActionCplCompFinalizeImpl#getPhase <em>Phase</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ESMFActionCplCompFinalizeImpl extends ESMFActionAPIImpl implements ESMFActionCplCompFinalize {
	/**
	 ...
	 * @generated
	 */
	protected ESMFActionCplCompFinalizeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ESMFPackage.Literals.ESMF_ACTION_CPL_COMP_FINALIZE;
	}
		...
		if (cplcomp != null && cplcomp.eIsProxy()) {
			...
			if (cplcomp != oldCplcomp) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ESMFPackage.ESMF_ACTION_CPL_COMP_FINALIZE__CPLCOMP, oldCplcomp, cplcomp));
			}
		}
		return cplcomp;
	}
	...
	public void setCplcomp(ESMFCouplerComponent newCplcomp) {
		...
		cplcomp = newCplcomp;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ESMFPackage.ESMF_ACTION_CPL_COMP_FINALIZE__CPLCOMP, oldCplcomp, cplcomp));
	}
	...
	public ESMFState getImportState() {
		if (importState != null && importState.eIsProxy()) {
			...
			if (importState != oldImportState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ESMFPackage.ESMF_ACTION_CPL_COMP_FINALIZE__IMPORT_STATE, oldImportState, importState));
			}
		}
		return importState;
	}
	...
	public void setImportState(ESMFState newImportState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ESMFPackage.ESMF_ACTION_CPL_COMP_FINALIZE__IMPORT_STATE, oldImportState, importState));
	}
	...
	public ESMFState getExportState() {
		if (exportState != null && exportState.eIsProxy()) {
			...
			if (exportState != oldExportState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ESMFPackage.ESMF_ACTION_CPL_COMP_FINALIZE__EXPORT_STATE, oldExportState, exportState));
			}
		}
		return exportState;
	}
	...
	public void setExportState(ESMFState newExportState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ESMFPackage.ESMF_ACTION_CPL_COMP_FINALIZE__EXPORT_STATE, oldExportState, exportState));
	}
	...
	public ESMFClock getClock() {
		if (clock != null && clock.eIsProxy()) {
			...
			if (clock != oldClock) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ESMFPackage.ESMF_ACTION_CPL_COMP_FINALIZE__CLOCK, oldClock, clock));
			}
		}
		return clock;
	}
	...
	public void setClock(ESMFClock newClock) {
		...
		clock = newClock;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ESMFPackage.ESMF_ACTION_CPL_COMP_FINALIZE__CLOCK, oldClock, clock));
	}
	...
	public void setPhase(String newPhase) {
		...
		phase = newPhase;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ESMFPackage.ESMF_ACTION_CPL_COMP_FINALIZE__PHASE, oldPhase, phase));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ESMFPackage.ESMF_ACTION_CPL_COMP_FINALIZE__CPLCOMP:
				if (resolve) return getCplcomp();
				return basicGetCplcomp();
			case ESMFPackage.ESMF_ACTION_CPL_COMP_FINALIZE__IMPORT_STATE:
				if (resolve) return getImportState();
				return basicGetImportState();
			case ESMFPackage.ESMF_ACTION_CPL_COMP_FINALIZE__EXPORT_STATE:
				if (resolve) return getExportState();
				return basicGetExportState();
			case ESMFPackage.ESMF_ACTION_CPL_COMP_FINALIZE__CLOCK:
