...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Action Field Halo Release</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.earthsystemcurator.cupid.esmf.impl.ESMFActionFieldHaloReleaseImpl#getRouteHandle <em>Route Handle</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ESMFActionFieldHaloReleaseImpl extends ESMFActionAPIImpl implements ESMFActionFieldHaloRelease {
	/**
	 ...
	 * @generated
	 */
	protected ESMFActionFieldHaloReleaseImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ESMFPackage.Literals.ESMF_ACTION_FIELD_HALO_RELEASE;
	}
		...
		if (routeHandle != null && routeHandle.eIsProxy()) {
			...
			if (routeHandle != oldRouteHandle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ESMFPackage.ESMF_ACTION_FIELD_HALO_RELEASE__ROUTE_HANDLE, oldRouteHandle, routeHandle));
			}
		}
		return routeHandle;
	}
	...
	public void setRouteHandle(ESMFRouteHandle newRouteHandle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ESMFPackage.ESMF_ACTION_FIELD_HALO_RELEASE__ROUTE_HANDLE, oldRouteHandle, routeHandle));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ESMFPackage.ESMF_ACTION_FIELD_HALO_RELEASE__ROUTE_HANDLE:
...
} //ESMFActionFieldHaloReleaseImpl
