...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Stage Action Field Redist</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.earthsystemcurator.cupid.esmf.impl.ESMFStageActionFieldRedistImpl#getSrcField <em>Src Field</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.esmf.impl.ESMFStageActionFieldRedistImpl#getDstField <em>Dst Field</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.esmf.impl.ESMFStageActionFieldRedistImpl#getRouteHandle <em>Route Handle</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ESMFStageActionFieldRedistImpl extends ESMFStageActionImpl implements ESMFStageActionFieldRedist {
	/**
	 ...
	 * @generated
	 */
	protected ESMFStageActionFieldRedistImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ESMFPackage.Literals.ESMF_STAGE_ACTION_FIELD_REDIST;
	}
		...
		if (srcField != null && srcField.eIsProxy()) {
			...
			if (srcField != oldSrcField) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ESMFPackage.ESMF_STAGE_ACTION_FIELD_REDIST__SRC_FIELD, oldSrcField, srcField));
			}
		}
		return srcField;
	}
	...
	public void setSrcField(ESMFField newSrcField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ESMFPackage.ESMF_STAGE_ACTION_FIELD_REDIST__SRC_FIELD, oldSrcField, srcField));
	}
	...
	public ESMFField getDstField() {
		if (dstField != null && dstField.eIsProxy()) {
			...
			if (dstField != oldDstField) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ESMFPackage.ESMF_STAGE_ACTION_FIELD_REDIST__DST_FIELD, oldDstField, dstField));
			}
		}
		return dstField;
	}
	...
	public void setDstField(ESMFField newDstField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ESMFPackage.ESMF_STAGE_ACTION_FIELD_REDIST__DST_FIELD, oldDstField, dstField));
	}
	...
	public ESMFRouteHandle getRouteHandle() {
		if (routeHandle != null && routeHandle.eIsProxy()) {
			...
			if (routeHandle != oldRouteHandle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ESMFPackage.ESMF_STAGE_ACTION_FIELD_REDIST__ROUTE_HANDLE, oldRouteHandle, routeHandle));
			}
		}
		return routeHandle;
	}
	...
	public void setRouteHandle(ESMFRouteHandle newRouteHandle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ESMFPackage.ESMF_STAGE_ACTION_FIELD_REDIST__ROUTE_HANDLE, oldRouteHandle, routeHandle));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ESMFPackage.ESMF_STAGE_ACTION_FIELD_REDIST__SRC_FIELD:
				if (resolve) return getSrcField();
				return basicGetSrcField();
			case ESMFPackage.ESMF_STAGE_ACTION_FIELD_REDIST__DST_FIELD:
				if (resolve) return getDstField();
				return basicGetDstField();
			case ESMFPackage.ESMF_STAGE_ACTION_FIELD_REDIST__ROUTE_HANDLE:
...
} //ESMFStageActionFieldRedistImpl
