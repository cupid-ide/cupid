...
/**
 * This is the item provider adapter for a {@link org.earthsystemcurator.cupid.nuopc.fsml.nuopc.AdvertisesImportField} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AdvertisesImportFieldItemProvider
	 ...
	 * @generated
	 */
	public AdvertisesImportFieldItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addAddsToImportStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AdvertisesImportField_addsToImportState_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AdvertisesImportField_addsToImportState_feature", "_UI_AdvertisesImportField_type"),
				 NUOPCPackage.Literals.ADVERTISES_IMPORT_FIELD__ADDS_TO_IMPORT_STATE,
				 true,
				 false,
				 false,
	...
	protected void addStandardNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AdvertisesImportField_standardName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AdvertisesImportField_standardName_feature", "_UI_AdvertisesImportField_type"),
				 NUOPCPackage.Literals.ADVERTISES_IMPORT_FIELD__STANDARD_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns AdvertisesImportField.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AdvertisesImportField"));
	}
	...
	public String getText(Object object) {
		String label = ((AdvertisesImportField)object).getStandardName();
		return label == null || label.length() == 0 ?
			getString("_UI_AdvertisesImportField_type") :
			getString("_UI_AdvertisesImportField_type") + " " + label;
	}
