...
/**
 * This is the item provider adapter for a {@link org.earthsystemcurator.cupid.nuopc.fsml.nuopc.NUOPCModel__ImplementsSetServices} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NUOPCModel__ImplementsSetServicesItemProvider
	 ...
	 * @generated
	 */
	public NUOPCModel__ImplementsSetServicesItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NUOPCModel__ImplementsSetServices_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NUOPCModel__ImplementsSetServices_name_feature", "_UI_NUOPCModel__ImplementsSetServices_type"),
				 NUOPCPackage.Literals.NUOPC_MODEL_IMPLEMENTS_SET_SERVICES__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NUOPCPackage.Literals.NUOPC_MODEL_IMPLEMENTS_SET_SERVICES__CALLS_GENERIC_SET_SERVICES);
			childrenFeatures.add(NUOPCPackage.Literals.NUOPC_MODEL_IMPLEMENTS_SET_SERVICES__CALLS_SET_ENTRY_POINT);
			childrenFeatures.add(NUOPCPackage.Literals.NUOPC_MODEL_IMPLEMENTS_SET_SERVICES__ATTACHES_METHOD);
		}
	...
	/**
	 * This returns NUOPCModel__ImplementsSetServices.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/NUOPCModel__ImplementsSetServices"));
	}
	...
	public String getText(Object object) {
		String label = ((NUOPCModel__ImplementsSetServices)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_NUOPCModel__ImplementsSetServices_type") :
			getString("_UI_NUOPCModel__ImplementsSetServices_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NUOPCPackage.Literals.NUOPC_MODEL_IMPLEMENTS_SET_SERVICES__CALLS_GENERIC_SET_SERVICES,
				 NUOPCFactory.eINSTANCE.createCallsGenericSetServices()));

		newChildDescriptors.add
			(createChildParameter
				(NUOPCPackage.Literals.NUOPC_MODEL_IMPLEMENTS_SET_SERVICES__CALLS_SET_ENTRY_POINT,
				 NUOPCFactory.eINSTANCE.createCallsSetEntryPoint()));

		newChildDescriptors.add
			(createChildParameter
				(NUOPCPackage.Literals.NUOPC_MODEL_IMPLEMENTS_SET_SERVICES__ATTACHES_METHOD,
