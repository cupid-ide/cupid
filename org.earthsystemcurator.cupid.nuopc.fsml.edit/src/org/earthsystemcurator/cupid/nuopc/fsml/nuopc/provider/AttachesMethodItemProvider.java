...
public class AttachesMethodItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addMethodLabelPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Method Label feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addMethodLabelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AttachesMethod_methodLabel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AttachesMethod_methodLabel_feature", "_UI_AttachesMethod_type"),
				 NUOPCPackage.Literals.ATTACHES_METHOD__METHOD_LABEL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((AttachesMethod)object).getMethodLabel();
