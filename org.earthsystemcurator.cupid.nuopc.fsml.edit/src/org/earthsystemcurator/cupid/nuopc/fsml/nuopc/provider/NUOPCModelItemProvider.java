...
public class NUOPCModelItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addUsesAllImportsPropertyDescriptor(object);
			addSinglePublicSubroutinePropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Uses All Imports feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addUsesAllImportsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NUOPCModel_usesAllImports_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NUOPCModel_usesAllImports_feature", "_UI_NUOPCModel_type"),
				 NUOPCPackage.Literals.NUOPC_MODEL__USES_ALL_IMPORTS,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Single Public Subroutine feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSinglePublicSubroutinePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NUOPCModel_singlePublicSubroutine_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NUOPCModel_singlePublicSubroutine_feature", "_UI_NUOPCModel_type"),
				 NUOPCPackage.Literals.NUOPC_MODEL__SINGLE_PUBLIC_SUBROUTINE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
