...
/**
 * This is the item provider adapter for a {@link org.earthsystemcurator.cupid.nuopc.fsml.nuopc.ModelAdvance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelAdvanceItemProvider
	 ...
	 * @generated
	 */
	public ModelAdvanceItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ModelAdvance_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ModelAdvance_name_feature", "_UI_ModelAdvance_type"),
				 NUOPCPackage.Literals.MODEL_ADVANCE__NAME,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ModelAdvance"));
	}
	...
	public String getText(Object object) {
		String label = ((ModelAdvance)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ModelAdvance_type") :
			getString("_UI_ModelAdvance_type") + " " + label;
	}
