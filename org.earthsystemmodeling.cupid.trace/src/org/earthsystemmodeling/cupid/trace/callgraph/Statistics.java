 ...
 * @since 1.3
 */
public class Statistics<@NonNull E> implements IStatistics<E>, Serializable {
    ...
    public void update(E object) {
        ...
        fMinValue = value <= getMin() ? value : getMin();
        fMaxValue = value >= getMax() ? value : getMax();
    ...
    private void copy(Statistics<E> copyOther) {
        ...
        fMax = copyOther.fMax;
        fMin = copyOther.fMin;
        fMinValue = copyOther.fMinValue;
        fMaxValue = copyOther.fMaxValue;
