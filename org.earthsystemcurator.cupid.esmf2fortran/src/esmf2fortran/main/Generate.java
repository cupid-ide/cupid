...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/esmf2fortran/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(SIDLPackage.class)) {
        	resourceSet.getPackageRegistry().put(SIDLPackage.eNS_URI, SIDLPackage.eINSTANCE);
        }
        
        if (!isInWorkspace(ESMFPackage.class)) {
        	resourceSet.getPackageRegistry().put(ESMFPackage.eNS_URI, ESMFPackage.eINSTANCE);
        }
