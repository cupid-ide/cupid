...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Model Advertises Import Field</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.earthsystemcurator.cupid.nuopc.fsml.nuopc.impl.NUOPCModel__AdvertisesImportFieldImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.nuopc.fsml.nuopc.impl.NUOPCModel__AdvertisesImportFieldImpl#getAddsToState <em>Adds To State</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.nuopc.fsml.nuopc.impl.NUOPCModel__AdvertisesImportFieldImpl#getRc <em>Rc</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.nuopc.fsml.nuopc.impl.NUOPCModel__AdvertisesImportFieldImpl#isAddsToImportState <em>Adds To Import State</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.nuopc.fsml.nuopc.impl.NUOPCModel__AdvertisesImportFieldImpl#getStandardName <em>Standard Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NUOPCModel__AdvertisesImportFieldImpl extends EObjectImpl implements NUOPCModel__AdvertisesImportField {
	/**
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate ADDS_TO_IMPORT_STATE__ESETTING_DELEGATE = ((EStructuralFeature.Internal)NUOPCPackage.Literals.NUOPC_MODEL_ADVERTISES_IMPORT_FIELD__ADDS_TO_IMPORT_STATE).getSettingDelegate();
	 ...
	 * @generated
	 */
	protected NUOPCModel__AdvertisesImportFieldImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return NUOPCPackage.Literals.NUOPC_MODEL_ADVERTISES_IMPORT_FIELD;
	}
	...
	public NUOPCModel__ImplementsInitP1 getParent() {
		if (eContainerFeatureID() != NUOPCPackage.NUOPC_MODEL_ADVERTISES_IMPORT_FIELD__PARENT) return null;
	...
	public NotificationChain basicSetParent(NUOPCModel__ImplementsInitP1 newParent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParent, NUOPCPackage.NUOPC_MODEL_ADVERTISES_IMPORT_FIELD__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(NUOPCModel__ImplementsInitP1 newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != NUOPCPackage.NUOPC_MODEL_ADVERTISES_IMPORT_FIELD__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__ADVERTISES_IMPORT_FIELD, NUOPCModel__ImplementsInitP1.class, msgs);
			msgs = basicSetParent(newParent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NUOPCPackage.NUOPC_MODEL_ADVERTISES_IMPORT_FIELD__PARENT, newParent, newParent));
	}
	...
	public void setAddsToState(String newAddsToState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NUOPCPackage.NUOPC_MODEL_ADVERTISES_IMPORT_FIELD__ADDS_TO_STATE, oldAddsToState, addsToState));
	}
	...
	public void setRc(String newRc) {
		...
		rc = newRc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NUOPCPackage.NUOPC_MODEL_ADVERTISES_IMPORT_FIELD__RC, oldRc, rc));
	}
	...
	public void setStandardName(String newStandardName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NUOPCPackage.NUOPC_MODEL_ADVERTISES_IMPORT_FIELD__STANDARD_NAME, oldStandardName, standardName));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case NUOPCPackage.NUOPC_MODEL_ADVERTISES_IMPORT_FIELD__PARENT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case NUOPCPackage.NUOPC_MODEL_ADVERTISES_IMPORT_FIELD__PARENT:
				return eInternalContainer().eInverseRemove(this, NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__ADVERTISES_IMPORT_FIELD, NUOPCModel__ImplementsInitP1.class, msgs);
		}
...
} //NUOPCModel__AdvertisesImportFieldImpl
