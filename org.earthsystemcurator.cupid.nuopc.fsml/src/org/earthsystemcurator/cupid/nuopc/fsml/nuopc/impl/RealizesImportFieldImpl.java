...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Realizes Import Field</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class RealizesImportFieldImpl extends EObjectImpl implements RealizesImportField {
	/**
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate REALIZED_IN_IMPORT_STATE__ESETTING_DELEGATE = ((EStructuralFeature.Internal)NUOPCPackage.Literals.REALIZES_IMPORT_FIELD__REALIZED_IN_IMPORT_STATE).getSettingDelegate();
	 ...
	 * @generated
	 */
	protected RealizesImportFieldImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return NUOPCPackage.Literals.REALIZES_IMPORT_FIELD;
	}
	...
	public ModelImplementsInitP2 getParent() {
		if (eContainerFeatureID() != NUOPCPackage.REALIZES_IMPORT_FIELD__PARENT) return null;
	...
	public NotificationChain basicSetParent(ModelImplementsInitP2 newParent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParent, NUOPCPackage.REALIZES_IMPORT_FIELD__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(ModelImplementsInitP2 newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != NUOPCPackage.REALIZES_IMPORT_FIELD__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, NUOPCPackage.MODEL_IMPLEMENTS_INIT_P2__REALIZES_IMPORT_FIELD, ModelImplementsInitP2.class, msgs);
			msgs = basicSetParent(newParent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NUOPCPackage.REALIZES_IMPORT_FIELD__PARENT, newParent, newParent));
	}
	...
	public void setRealizedInState(String newRealizedInState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NUOPCPackage.REALIZES_IMPORT_FIELD__REALIZED_IN_STATE, oldRealizedInState, realizedInState));
	}
	...
	public void setField(String newField) {
		...
		field = newField;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NUOPCPackage.REALIZES_IMPORT_FIELD__FIELD, oldField, field));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case NUOPCPackage.REALIZES_IMPORT_FIELD__PARENT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case NUOPCPackage.REALIZES_IMPORT_FIELD__PARENT:
				return eInternalContainer().eInverseRemove(this, NUOPCPackage.MODEL_IMPLEMENTS_INIT_P2__REALIZES_IMPORT_FIELD, ModelImplementsInitP2.class, msgs);
		}
