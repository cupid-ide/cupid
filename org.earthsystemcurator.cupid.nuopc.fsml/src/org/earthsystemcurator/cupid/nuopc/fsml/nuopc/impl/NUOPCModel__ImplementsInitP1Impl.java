 ...
 * <ul>
 *   <li>{@link org.earthsystemcurator.cupid.nuopc.fsml.nuopc.impl.NUOPCModel__ImplementsInitP1Impl#getParent <em>Parent</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.nuopc.fsml.nuopc.impl.NUOPCModel__ImplementsInitP1Impl#getName <em>Name</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.nuopc.fsml.nuopc.impl.NUOPCModel__ImplementsInitP1Impl#getImportParam <em>Import Param</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.nuopc.fsml.nuopc.impl.NUOPCModel__ImplementsInitP1Impl#getExportParam <em>Export Param</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.nuopc.fsml.nuopc.impl.NUOPCModel__ImplementsInitP1Impl#getAdvertisesImportField <em>Advertises Import Field</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.nuopc.fsml.nuopc.impl.NUOPCModel__ImplementsInitP1Impl#getAdvertisesExportField <em>Advertises Export Field</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.nuopc.fsml.nuopc.impl.NUOPCModel__ImplementsInitP1Impl#isAdvertisesAtLeastOneField <em>Advertises At Least One Field</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.nuopc.fsml.nuopc.impl.NUOPCModel__ImplementsInitP1Impl#isRegisteredInSetServices <em>Registered In Set Services</em>}</li>
 *   <li>{@link org.earthsystemcurator.cupid.nuopc.fsml.nuopc.impl.NUOPCModel__ImplementsInitP1Impl#isAdvertisesOrRegistered <em>Advertises Or Registered</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NUOPCModel__ImplementsInitP1Impl extends EObjectImpl implements NUOPCModel__ImplementsInitP1 {
	/**
	 ...
	 * @ordered
	 */
	protected EList<NUOPCModel__AdvertisesImportField> advertisesImportField;
	 ...
	 * @ordered
	 */
	protected EList<NUOPCModel__AdvertisesExportField> advertisesExportField;
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate ADVERTISES_AT_LEAST_ONE_FIELD__ESETTING_DELEGATE = ((EStructuralFeature.Internal)NUOPCPackage.Literals.NUOPC_MODEL_IMPLEMENTS_INIT_P1__ADVERTISES_AT_LEAST_ONE_FIELD).getSettingDelegate();
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate REGISTERED_IN_SET_SERVICES__ESETTING_DELEGATE = ((EStructuralFeature.Internal)NUOPCPackage.Literals.NUOPC_MODEL_IMPLEMENTS_INIT_P1__REGISTERED_IN_SET_SERVICES).getSettingDelegate();
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate ADVERTISES_OR_REGISTERED__ESETTING_DELEGATE = ((EStructuralFeature.Internal)NUOPCPackage.Literals.NUOPC_MODEL_IMPLEMENTS_INIT_P1__ADVERTISES_OR_REGISTERED).getSettingDelegate();
	 ...
	 * @generated
	 */
	protected NUOPCModel__ImplementsInitP1Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return NUOPCPackage.Literals.NUOPC_MODEL_IMPLEMENTS_INIT_P1;
	}
	...
	public NUOPCModel__Init getParent() {
		if (eContainerFeatureID() != NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__PARENT) return null;
	...
	public NotificationChain basicSetParent(NUOPCModel__Init newParent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParent, NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(NUOPCModel__Init newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, NUOPCPackage.NUOPC_MODEL_INIT__IMPLEMENTS_INIT_P1, NUOPCModel__Init.class, msgs);
			msgs = basicSetParent(newParent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__PARENT, newParent, newParent));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__NAME, oldName, name));
	}
	...
	public void setImportParam(String newImportParam) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__IMPORT_PARAM, oldImportParam, importParam));
	}
	...
	public void setExportParam(String newExportParam) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__EXPORT_PARAM, oldExportParam, exportParam));
	}
	 ...
	 * @generated
	 */
	public EList<NUOPCModel__AdvertisesImportField> getAdvertisesImportField() {
		if (advertisesImportField == null) {
			advertisesImportField = new EObjectContainmentWithInverseEList<NUOPCModel__AdvertisesImportField>(NUOPCModel__AdvertisesImportField.class, this, NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__ADVERTISES_IMPORT_FIELD, NUOPCPackage.NUOPC_MODEL_ADVERTISES_IMPORT_FIELD__PARENT);
		}
	 ...
	 * @generated
	 */
	public EList<NUOPCModel__AdvertisesExportField> getAdvertisesExportField() {
		if (advertisesExportField == null) {
			advertisesExportField = new EObjectContainmentWithInverseEList<NUOPCModel__AdvertisesExportField>(NUOPCModel__AdvertisesExportField.class, this, NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__ADVERTISES_EXPORT_FIELD, NUOPCPackage.NUOPC_MODEL_ADVERTISES_EXPORT_FIELD__PARENT);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__PARENT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetParent((NUOPCModel__Init)otherEnd, msgs);
			case NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__ADVERTISES_IMPORT_FIELD:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getAdvertisesImportField()).basicAdd(otherEnd, msgs);
			case NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__ADVERTISES_EXPORT_FIELD:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__PARENT:
				return eInternalContainer().eInverseRemove(this, NUOPCPackage.NUOPC_MODEL_INIT__IMPLEMENTS_INIT_P1, NUOPCModel__Init.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__PARENT:
				return getParent();
			case NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__NAME:
				return getName();
			case NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__IMPORT_PARAM:
				return getImportParam();
			case NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__EXPORT_PARAM:
				return getExportParam();
			case NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__ADVERTISES_IMPORT_FIELD:
				return getAdvertisesImportField();
			case NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__ADVERTISES_EXPORT_FIELD:
				return getAdvertisesExportField();
			case NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__ADVERTISES_AT_LEAST_ONE_FIELD:
				return isAdvertisesAtLeastOneField();
			case NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__REGISTERED_IN_SET_SERVICES:
				return isRegisteredInSetServices();
			case NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__ADVERTISES_OR_REGISTERED:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__ADVERTISES_IMPORT_FIELD:
				...
				getAdvertisesImportField().addAll((Collection<? extends NUOPCModel__AdvertisesImportField>)newValue);
				return;
			case NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__ADVERTISES_EXPORT_FIELD:
				getAdvertisesExportField().clear();
				getAdvertisesExportField().addAll((Collection<? extends NUOPCModel__AdvertisesExportField>)newValue);
				return;
			case NUOPCPackage.NUOPC_MODEL_IMPLEMENTS_INIT_P1__ADVERTISES_AT_LEAST_ONE_FIELD:
...
} //NUOPCModel__ImplementsInitP1Impl
