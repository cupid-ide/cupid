# -*- coding: utf-8 -*-
#
# NUOPC documentation build configuration file, created by
...
# fortran source to autodoc
#fortran_src = ['include/*.F90']
#fortran_ext = ['F90', 'f90']
...
NASA Goddard Space Flight Center.  All rights reserved.'''

author = u'Earth System Modeling Framework team'
...
version = '7.0 beta snapshot 58'
# The full version, including alpha/beta/rc tags.
release = '7.0 beta snapshot 58'
...
if not is_cupid:
  exclude_patterns.append('indexcupid.rst')
else:
...
man_pages = [
    (master_doc, 'nuopc', u'NUOPC Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'NUOPC', u'NUOPC Documentation',
   author, 'NUOPC', 'One line description of project.',
   'Miscellaneous'),
]
